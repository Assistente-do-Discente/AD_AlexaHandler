...
public class GradeByDisciplineNameIntentHandler extends BaseIntentHandler implements RequestHandler {

    public GradeByDisciplineNameIntentHandler(ApiAssistenteDiscente apiAssistenteDiscente) {
        super(apiAssistenteDiscente);
    }

    @Override
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("GradeByDisciplineNameIntent"));
    }
